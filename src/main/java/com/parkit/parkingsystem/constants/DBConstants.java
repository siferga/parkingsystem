...
public class DBConstants {
    ...
    public static final String REGULAR_CUSTOMER = "select * from ticket where VEHICLE_REG_NUMBER = ?";
    public static final String LOOK_FOR_TICKET = "select * from ticket where VEHICLE_REG_NUMBER = ?";
}

...
public class FareCalculatorServiceTest {
    ...
    @Test
    public void calculateFareLessThanThirtyMinutesCar(){
        Date inTime = new Date();
    ...
    @Test
    public void calculateFareLessThanThirtyMinutesBike(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  25 * 60 * 1000) );
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE,false);
    ...
    @Test
    public void FareDiscountForRegularCustomer(){
        //entrée en dur
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (60 * 60 * 1000) );//1H IN PARKING
        //sortie
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR,false);
        ...
        Mockito.when(ticketDAO.compareTicket(Mockito.any())).thenReturn(true);
        fareCalculatorService.calculateFare(ticket);
        //assertEquals((1 * Fare.BIKE_RATE_PER_HOUR-((1 * Fare.BIKE_RATE_PER_HOUR) * 5/100)), ticket.getPrice());
